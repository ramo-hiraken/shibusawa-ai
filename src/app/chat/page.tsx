...
const stepIntros: Record<number, { title: string; aiGreeting: string; suggestions: string[] }> = {
  1: {
    title: "社会課題の発見",
    aiGreeting: "いい探求のスタートですね！まず、最近の生活の中で「これ不便だな」「あの人大変そうだな」と感じたことを教えてください。ニュースで見たことでも、通学中に気づいたことでもOKです。",
    suggestions: [
      "近所のおばあちゃんが重い荷物を持ってバス停で立ってた",
      "コンビニのバイト先で毎晩大量の弁当を捨ててる",
      "駅前の商店街がどんどんシャッター街になってきた",
    ],
  },
  2: {
    title: "課題の深掘り",
    aiGreeting: "その課題、もう少し深く見てみましょう。「なんでそうなっているのか？」を一緒に考えると、本当に解決すべきポイントが見えてきます。",
    suggestions: [
      "親に聞いたら昔はもっと店があったらしい",
      "ネットで調べたら全国的な問題みたい",
      "実際に当事者の人に話を聞いてみた",
  ...
  3: {
    title: "解決策の構想",
    aiGreeting: "課題が見えてきましたね。ここからが面白いところです！「自分たちに何ができるか？」を自由に考えてみましょう。ぶっ飛んだアイデアでも全然OKです。",
    suggestions: [
      "LINEで注文して高校生が届ける買い物代行サービス",
      "廃棄食品を安く売れる学校内マルシェ",
      "空き店舗で高校生が週末だけ営業するカフェ",
    ],
  },
  4: {
    title: "実現可能性の検討",
    aiGreeting: "いいアイデアが出てきましたね！ここからは「本当にやれるか？」をリアルに考えてみましょう。夢を語るだけじゃなく、最初の一歩を具体的にするのが大事です。",
    suggestions: [
      "まず近所の人5人に「使いたいか」聞いてみる",
      "初期費用がいくらかかるか計算してみた",
      "校長先生に相談したらどうなるか気になる",
    ],
  },
